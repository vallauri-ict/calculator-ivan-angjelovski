...
namespace Calculator_FormProject
{
    public partial class frmMain : Form
    {
        ...
        private ButtonStruct[,] buttons =
        {
            ...
            {new ButtonStruct(' ',false),new ButtonStruct(' ',false),new ButtonStruct(' ',false),new ButtonStruct('/',false)},
            {new ButtonStruct('1',true),new ButtonStruct('2',true),new ButtonStruct('3',true),new ButtonStruct('x',false)},
